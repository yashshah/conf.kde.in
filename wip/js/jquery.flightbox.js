...
/*
     FILE ARCHIVED ON 8:44:20 Aug 19, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:04:06 Nov 11, 2013.
 ...
 * @license    /web/20110819084420/http://www.gnu.org/licenses/gpl.txt GPL 2.0
 * @version    1.0.2
 * @link       /web/20110819084420/http://co.deme.me/projects/flickr-gallery/
 */
;(function($){
	...
	$.flightboxShow = function($calling, options) {
		...
		$image.load(function(){
			...
			if ( $calling.hasClass("video") ) {
				...
				$image.before('<div id="flightbox-video" style="display: none;"><object type="application/x-shockwave-flash" width="' + $image.width() + '" height="' + $image.height() + '" data="/web/20110819084420/http://www.flickr.com/apps/video/stewart.swf?v=67090&photo_id=' + photo_id + '&photo_secret=' + photo_secret + '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param name="movie" value="/web/20110819084420/http://www.flickr.com/apps/video/stewart.swf?v=67090&photo_id=' + photo_id + '&photo_secret=' + photo_secret + '"></param>								<param name="bgcolor" value="#000000"></param>								<param name="allowFullScreen" value="true"></param>								<embed type="application/x-shockwave-flash" src="/web/20110819084420/http://www.flickr.com/apps/video/stewart.swf?v=67090&photo_id=' + photo_id + '&photo_secret=' + photo_secret + '" bgcolor="#000000" allowfullscreen="true" flashvars="intl_lang=en-us&amp;photo_secret=' + photo_secret + '&amp;photo_id=' + photo_id + '" width="' + $image.width() + '" height="' + $image.height() + '"></embed></object></div>').hide();
